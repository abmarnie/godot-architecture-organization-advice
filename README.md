...
- **Be Consistent**: The more consistent things are structured, the easier it is to navigate and make changes. Note that, in particular, it is [officially recommended](https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/gdscript_styleguide.html#code-order) to order script members in the following way:
```
01. @tool
02. class_name
03. extends
