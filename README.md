...
- **Tech Stack Updates**: Consider updating Godot, .NET/C#, etc., depending on the release timeline for your game. If your game is to be release in, say, only 6 months to a year from now, it probably is worth completely locking down all dependencies versions.
